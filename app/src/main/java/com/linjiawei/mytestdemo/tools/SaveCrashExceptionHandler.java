...
/**
 * Created by LinJiawei on 2017/12/28. 10:40
...
public class SaveCrashExceptionHandler implements Thread.UncaughtExceptionHandler {
        ...
        private static SaveCrashExceptionHandler instance = new SaveCrashExceptionHandler();
        ...
        private SaveCrashExceptionHandler() {
        }

        /** 获取CrashHandler实例 ,单例模式 */
        public static SaveCrashExceptionHandler getInstance() {
            return instance;
        }
        ...
        private boolean handleException(Throwable ex) {
            ...
            try {
                ...
                new Thread() {
                    ...
                    public void run() {
                        Looper.prepare();
                        Toast.makeText(mContext, "很抱歉,程序出现异常,需要重启.", Toast.LENGTH_LONG).show();
                        Looper.loop();
                    }
                }.start();
                // 收集设备参数信息
        ...
        private String writeFile(String sb) throws Exception {
            ...
            String path = getGlobalpath(mContext);
        ...
        /*public void autoClear(final int autoClearDay) {
            FileUtil.delete(getGlobalpath(mContext), new FilenameFilter() {
