package com.linjiawei.mytestdemo.customview;
...
/**
 * 手势图片缩放控件：
 * 全部的功能仅一个类文件，没有依赖任何特殊的外部库，非常易于集成。
 * 具体见:https://github.com/boycy815/PinchImageView
 *
 * @author clifford
 */
public class PinchImageView extends ImageView {
    ...
    public void setOnClickListener(OnClickListener l) {
        //默认的click会在任何点击情况下都会触发，所以换成自己的
        mOnClickListener = l;
    }

    @Override
    public void setOnLongClickListener(OnLongClickListener l) {
        //默认的long click会在任何长按情况下都会触发，所以换成自己的
